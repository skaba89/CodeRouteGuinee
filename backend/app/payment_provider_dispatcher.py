...
def _celcom_money_payment_safe(phone: str, amount_gnf: int) -> ProviderResult:
    ...
    # Celcom n'est pas exposé dans le mode provider production. En dev/pilote,
    # l'absence de credentials reste simulable pour conserver les tests locaux.
...
def dispatch_mobile_money_payment(provider: str, phone: str, amount_gnf: int) -> ProviderResult:
    ...
    # Défense en profondeur : aucun chemin implicite vers sandbox.
