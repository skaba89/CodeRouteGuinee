...
def test_predeploy_is_fail_closed_and_does_not_log_database_url() -> None:
...
def test_production_entrypoint_does_not_migrate_or_seed_by_default() -> None:
...
def test_restore_drill_refuses_protected_database_and_requires_opt_in() -> None:
...
def test_backup_has_checksum_manifest_and_no_plaintext_url_output() -> None:
